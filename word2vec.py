...
tf.app.flags.DEFINE_string('lgo_dir', 'logs/', 'Log directory.')
...
train_op = tf.tran.GradientDescentOptimizer(FLAGS.learning_rate).minimize(loss, global_step=global_step)
